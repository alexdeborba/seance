 ...
 * Slug: seancewp/blog-light-posts-query-left-sidebar
 * Categories: pages
 * Description: Blog posts with left sidebar on a light block pattern
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--custom--spacing--small, 1.25rem);padding-bottom:var(--wp--custom--spacing--small, 1.25rem)">
    ...
    <div class="wp-block-columns alignwide has-foreground-color has-text-color has-link-color" style="margin-top:0px;margin-bottom:0px">
        ...
        <div class="wp-block-column" style="flex-basis:33.33%">
            ...
            <h4 class="has-large-font-size"><em><?php echo esc_html_e('Categories', 'seancewp'); ?></em></h4>
            <!-- /wp:heading -->
            ...
            <!-- /wp:spacer -->
            <!-- wp:heading {"level":4,"fontSize":"large"} -->
            <h4 class="has-large-font-size"><em><?php echo esc_html_e('Pages', 'seancewp'); ?></em></h4>
            <!-- /wp:heading -->
