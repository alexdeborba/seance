 ...
 * Slug: seancewp/about-light-text-two-columns
 * Categories: pages
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--custom--spacing--large, 8rem);padding-bottom:var(--wp--custom--spacing--large, 8rem);">
    ...
    <h1 class="alignwide" style="font-size:clamp(4rem, 15vw, 12.5rem);font-weight:200;line-height:1"><?php echo wp_kses_post(__('<em>Life </em><br><em>&amp; Death</em>', 'seancewp')); ?></h1>
    <!-- /wp:heading -->
    <!-- wp:spacer {"height":50} -->
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-columns">
            ...
            <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:20%">
                <!-- wp:paragraph -->
                <p><?php echo wp_kses_post(__('Greetings', 'seancewp')); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:column -->
