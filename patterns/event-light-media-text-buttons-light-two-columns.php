 ...
 * Slug: seancewp/event-light-media-text-buttons-light-two-columns
...
<div class="wp-block-group alignwide">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column" style="padding-top:8rem;padding-right:0rem;padding-bottom:8rem;padding-left:0rem">
            ...
            <h2 class="has-x-large-font-size" id="spiritual-summit"><?php echo esc_html_e('Spiritual Summit', 'seancewp'); ?></h2>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            ...
            <div class="wp-block-buttons">
                ...
                <div class="wp-block-button"><a class="wp-block-button__link has-foreground-background-color has-background"><?php echo esc_html_e('Buy Tickets', 'seancewp'); ?></a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
        </div>
        ...
        <div class="wp-block-column" style="padding-top:8rem;padding-right:0rem;padding-bottom:8rem;padding-left:0rem">
            ...
            <!-- /wp:spacer -->
            <!-- wp:heading {"fontSize":"x-large"} -->
            <h2 class="has-x-large-font-size" id="ethereal-echoes"><?php echo esc_html_e('Ethereal Echoes', 'seancewp'); ?></h2>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            ...
            <div class="wp-block-buttons">
                <!-- wp:button {"backgroundColor":"foreground"} -->
                <div class="wp-block-button"><a class="wp-block-button__link has-foreground-background-color has-background"><?php echo wp_kses_post(__('Buy Tickets', 'seancewp')); ?></a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
        </div>
