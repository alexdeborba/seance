 ...
 * Slug: seance/media-duotone-right-text-buttons-left-columns
 * Categories: posts
...
<div class="wp-block-group has-responsive-dark-background has-primary-color has-text-color has-background" style="background:linear-gradient(90deg,rgb(15,15,16) 70%,rgba(0,0,0,0) 20%);margin-top:0px;margin-bottom:0px;padding-top:3em;padding-right:0px;padding-bottom:3em;padding-left:0px">
            ...
            <div class="wp-block-columns">
                ...
                <div class="wp-block-column" style="padding-top:5%;padding-bottom:5%;padding-left:0px;flex-basis:66.66%">
                    ...
                    <div class="wp-block-buttons">
                        ...
                        <div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-foreground-background-color has-background wp-element-button" href="#" rel=""><?php echo esc_html_e('Learn More', 'seance'); ?></a></div>
                        <!-- /wp:button -->
