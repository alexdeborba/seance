<?php
/**
 * Title: Blog posts with right sidebar
 * Slug: seance/page-sidebar-blog-posts-right
 * Categories: pages
 * Description: Blog posts with right sidebar block pattern
...
<figure class="wp-block-image size-large"><img src="<?php esc_url( get_template_directory_uri() ) ?>/assets/images/thumbnail.jpg" alt="' . esc_attr__( 'Illustration', 'seance' ) . '"/></figure>
<!-- /wp:image -->
...
<h4 class="has-large-font-size"><em><?php echo esc_html__( 'Categories', 'seance' ) ?></em></h4>
<!-- /wp:heading -->

<!-- wp:tag-cloud {"taxonomy":"category","showTagCounts":true} /-->

<!-- wp:heading {"level":4,"fontSize":"large"} -->
<h4 class="has-large-font-size"><em><?php esc_html__( 'Tags', 'seance' ) ?></em></h4>
<!-- /wp:heading -->
