<?php
/**
 * Title: Footer light with posts query loop, featured images, title, date, and excerpt
 * Slug: seancewp/footer-light-posts
 * Categories: footer
 * Description: Footer with posts query on a light block pattern
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"4rem","bottom":"4rem"}},"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"backgroundColor":"primary","textColor":"background","layout":{"inherit":true}} -->
<div class="wp-block-group alignfull has-background-color has-primary-background-color has-text-color has-background has-link-color" style="padding-top:4rem;padding-bottom:4rem">
    ...
    <div class="wp-block-query alignwide">
        ...
        <!-- wp:post-date {"textColor":"foreground","isLink":true} /-->
        <!-- /wp:post-template -->
    </div>
    <!-- /wp:query -->
    <!-- wp:spacer -->
