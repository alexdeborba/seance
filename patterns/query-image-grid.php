<?php
/**
 * Title: Grid of image posts
 * Slug: seance/query-image-grid
 * Categories: query
 * Description: Grid of image posts
 * Keywords: gallery, grid, images, posts
...
return array(
	'title'      => __( 'Grid of image posts', 'seance' ),
