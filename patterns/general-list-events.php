<?php
/**
 * Séance: List of events block pattern
 */
return array(
	'title'      => __( 'List of events', 'seance' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--custom--spacing--large, 8rem)","bottom":"var(--wp--custom--spacing--large, 8rem)"}},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"backgroundColor":"primary","textColor":"background"} -->
					...
					<h2 class="alignwide" style="font-size:clamp(3.25rem, 8vw, 6.25rem);line-height:1.15;margin-bottom:2rem"><em>' . esc_html__( 'Speaker Series', 'seance' ) . '</em></h2>
					<!-- /wp:heading -->
					...
					<p>' . esc_html__( 'March 15th, 1977, 6:45 AM', 'seance' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->

					<!-- wp:column {"verticalAlignment":"center"} -->
					<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"x-large"} -->
					<h2 class="has-x-large-font-size" id="alex-de-borba">' . esc_html__( 'Alex de Borba', 'seance' ) . '</h2>
					<!-- /wp:heading --></div>
					<!-- /wp:column -->

					<!-- wp:column {"verticalAlignment":"center"} -->
					<div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph -->
					<p>' . wp_kses_post( __( 'Teatro Angrense<br> R. da Esperança n.º 48-52<br>Angra do Heroísmo, Ilha Terceira', 'seance' ) ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns -->
