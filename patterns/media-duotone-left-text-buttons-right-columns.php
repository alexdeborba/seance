...
<!-- wp:group {"style":{"color":{"gradient":"linear-gradient(90deg,rgba(0,0,0,0) 30%,rgb(15,15,16) 30%)"},"spacing":{"padding":{"top":"3em","right":"0%","bottom":"3em","left":"0px"},"margin":{"top":"0px","bottom":"0px"}}},"textColor":"primary","layout":{"type":"constrained","contentSize":"80%"}} -->
<div class="wp-block-group has-primary-color has-text-color has-background" style="background:linear-gradient(90deg,rgba(0,0,0,0) 30%,rgb(15,15,16) 30%);margin-top:0px;margin-bottom:0px;padding-top:3em;padding-right:0%;padding-bottom:3em;padding-left:0px">
