<?php
/**
 * Séance: Footer with social links and copyright
 */
return array(
	'title'      => __( 'Footer with social links and copyright', 'seance' ),
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} -->
					...
					<p class="has-text-align-center" style="font-size:16px">' . esc_html__( '© Site Title', 'seance' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group -->',
);
