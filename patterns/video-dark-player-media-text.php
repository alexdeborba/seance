 ...
 * Slug: seancewp/video-dark-player-media-text
...
<div class="wp-block-group alignfull has-primary-color has-foreground-background-color has-text-color has-background has-link-color" style="padding-top:var(--wp--custom--spacing--large, 8rem);padding-bottom:var(--wp--custom--spacing--large, 8rem)">
    ...
    <div class="wp-block-group alignfull">
        ...
        <h1 class="alignwide" id="warble-a-film-about-hobbyist-bird-watchers-1" style="font-size:clamp(3rem, 6vw, 4.5rem)"><?php echo wp_kses_post(__('<em>\'Séance,\'</em> a film exploring the<br>enigmatic world of spirits.', 'seancewp')); ?></h1>
        <!-- /wp:heading -->
        <!-- wp:spacer {"height":32} -->
        <div style="height:32px" aria-hidden="true" class="wp-block-spacer"></div>
        <!-- /wp:spacer -->
        <!-- wp:video {"align":"wide"} -->
        <figure class="wp-block-video alignwide"><video controls src="<?php echo esc_url(get_theme_file_uri("/assets/videos/seancewp.mp4")); ?>"></video></figure>
        <!-- /wp:video -->
        <!-- wp:spacer {"height":32} -->
        <div style="height:32px" aria-hidden="true" class="wp-block-spacer"></div>
        <!-- /wp:spacer -->
        ...
        <div class="wp-block-columns alignwide">
            ...
            <div class="wp-block-column" style="flex-basis:50%">
                <!-- wp:paragraph -->
                <p><strong><?php echo esc_html_e('Featuring', 'seancewp'); ?></strong></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:column -->
            <!-- wp:column -->
            <div class="wp-block-column">
                <!-- wp:paragraph -->
                <p><?php echo wp_kses_post(__('Margaret Fox<br>Catherine Fox<br>Leah Fox<br>Eusapia Palladino<br>Sir Arthur Conan Doyle', 'seancewp')); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:column -->
            <!-- wp:column -->
            <div class="wp-block-column">
                <!-- wp:paragraph -->
                <p><?php echo wp_kses_post(__('Daniel Dunglas Home<br>Florence Cook<br>William Stainton Moses<br>Helena Blavatsky<br>Leonora Piper', 'seancewp')); ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:column -->
        </div>
