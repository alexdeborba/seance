<?php
/**
 * Title: Event light session with media on the left, and date, name, location on right sidebar
 * Slug: seancewp/event-light-media-text-right-sidebar
 * Categories: text, media, sidebar
 * Description: Event session with right sidebar on light block pattern
...
<div class="wp-block-group alignfull">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column" style="flex-basis:70%">
            ...
            <h1 class="alignwide" style="font-size:clamp(3rem, 6vw, 4.5rem);margin-bottom:0px"><?php echo wp_kses_post(__('<em>Hydesville Hauntings:</em> Fox Sisters\' Paranormal Parley', 'seancewp')); ?></h1>
            <!-- /wp:heading -->
        </div>
        <!-- /wp:column -->
        <!-- wp:column {"width":""} -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column">
            ...
            <h3 class="has-large-font-size"><em><?php echo esc_html_e('Event', 'seancewp'); ?></em></h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            ...
            <!-- /wp:spacer -->
            <!-- wp:heading {"level":3,"fontSize":"large"} -->
            <h3 class="has-large-font-size"><em><?php esc_html_e('Hosts', 'seancewp'); ?></em></h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            ...
            <!-- /wp:spacer -->
            <!-- wp:heading {"level":3,"fontSize":"large"} -->
            <h3 class="has-large-font-size"><em><?php echo esc_html_e('Date', 'seancewp'); ?></em></h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            ...
            <!-- /wp:spacer -->
            <!-- wp:heading {"level":3,"fontSize":"large"} -->
            <h3 class="has-large-font-size"><em><?php esc_html_e('Location', 'seancewp'); ?></em></h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
