 ...
 * Slug: seance/event-light-media-text-right-sidebar
...
<div class="wp-block-group alignfull">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column" style="flex-basis:70%">
            ...
            <h1 class="alignwide" style="font-size:clamp(3rem, 6vw, 4.5rem);margin-bottom:0px"><?php echo wp_kses_post(__('<em>Hydesville Hauntings:</em> Fox Sisters\' Paranormal Parley', 'seance')); ?></h1>
            <!-- /wp:heading -->
        </div>
        <!-- /wp:column -->
        <!-- wp:column {"width":""} -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column">
            ...
            <h3 class="has-large-font-size"><em><?php echo esc_html_e('Event', 'seance'); ?></em></h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            ...
            <!-- /wp:spacer -->
            <!-- wp:heading {"level":3,"fontSize":"large"} -->
            <h3 class="has-large-font-size"><em><?php esc_html_e('Hosts', 'seance'); ?></em></h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            ...
            <!-- /wp:spacer -->
            <!-- wp:heading {"level":3,"fontSize":"large"} -->
            <h3 class="has-large-font-size"><em><?php echo esc_html_e('Date', 'seance'); ?></em></h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            ...
            <!-- /wp:spacer -->
            <!-- wp:heading {"level":3,"fontSize":"large"} -->
            <h3 class="has-large-font-size"><em><?php esc_html_e('Location', 'seance'); ?></em></h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
