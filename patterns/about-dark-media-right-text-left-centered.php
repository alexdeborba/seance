<?php
/**
 * Title: About - Dark (Media on Right, Heading, Paragraph, and Social Icons Centered Left)
 * Slug: seance/about-dark-media-right-text-left-centered
 * Categories: about, dark, heading, image, paragraph, social
 * Description: A dark block pattern for an about section featuring media on the right and text centered on the left.
...
<div class="wp-block-group alignfull">
    ...
    <div class="wp-block-media-text alignfull has-media-on-the-right is-stacked-on-mobile has-background-color has-foreground-background-color has-text-color has-background has-link-color">
        <figure class="wp-block-media-text__media"><img src="<?php echo esc_url(get_theme_file_uri("/assets/images/about-dark-right.jpg")); ?>" alt="<?php echo esc_html_e('Image Representation of The Fox Sisters', 'seance'); ?>" /></figure>
