<?php
/**
 * Title: Page layout with image, and text
 * Slug: seance/page-layout-image-and-text
 * Categories: pages
 * Description: Page layout with image and text block pattern
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--custom--spacing--large, 8rem)","bottom":"2rem"}}},"layout":{"inherit":true}} -->
...
<h2 class="alignwide" style="font-size:clamp(4rem, 8vw, 7.5rem);font-weight:300;line-height:1.15"><?php wp_kses_post( __( '<em>Watching Birds </em><br><em>in the Garden</em>', 'seance' ) ) ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:image {"align":"full","style":{"color":{}}} -->
<figure class="wp-block-image alignfull"><img src="<?php esc_url( get_template_directory_uri() ) ?>/assets/images/flight-path-on-transparent-b.png" alt="<? esc_attr_x( 'TBD', 'Short for to be determined', 'seance' ) ?>"/></figure>
<!-- /wp:image -->
