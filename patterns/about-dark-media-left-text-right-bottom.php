<?php
/**
 * Title: About - Dark (Media on Left, Heading, Paragraph, and Social Icons Bottom Right)
 * Slug: seance/about-dark-media-left-text-right-bottom
 * Categories: about, dark, image, paragraph, social
 * Description: A dark block pattern for an About section featuring media on the left and text bottom on the right.
