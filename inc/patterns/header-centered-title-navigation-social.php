<?php
/**
 * Séance: Centered header with navigation, social links, and light background block pattern
 */
return array(
	'title'      => __( 'Centered header with navigation, social links, and light background', 'seance' ),
